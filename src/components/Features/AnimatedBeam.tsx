...
const Icons = {
  ...
  openai: () => (
    <svg
      ...
      height="150"
    >
      <rect x="45" y="100" width="10" height="40" fill="#8B4513" />

      <circle cx="50" cy="70" r="30" fill="green" />
      <circle cx="30" cy="80" r="25" fill="green" />
      <circle cx="70" cy="80" r="25" fill="green" />

      <rect x="0" y="140" width="100" height="10" fill="#228B22" />
    </svg>
  ),
  googleDrive: () => (
    <svg
